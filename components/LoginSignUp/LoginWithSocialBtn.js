...
const LoginWithSocialBtn = ({icon, label, provider}) => {
    return (
        <button className='w-full flex items-center shadow appearance-none border rounded px-4 py-2 text-sm hover:bg-more-light-purple' onClick={() => signIn(provider, {callbackUrl: 'http://localhost:3000/explore'})}>
