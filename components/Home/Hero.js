    ...
    return (
        <>
            <Section style='flex flex-col-reverse lg:flex-row pt-20 lg:pt-16 lg:-mb-40'>
                <div className='flex lg:max-w-[1000px] lg:justify-between lg:h-screen lg:max-h-[1024px] lg:items-center'>
                    <div className='flex flex-col gap-3 mt-16 lg:m-0 lg:w-1/2 lg:relative lg:-mt-20'>
                        ...
                        <p className='w-11/12 mb-2 text-sm leading-relaxed text-text-secondary lg:text-base'>{text[0][2].split('(')[0]} <span className='italic font-semibold'>({text[0][2].split('(')[1]}</span></p>
                        <Link href='#quiz'>
